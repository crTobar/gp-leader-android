...
// ── Backgrounds ─────────────────────────────────────────────────────────────
val Background     = Color(0xFFECEEF1) // Fondo general (neumórfico)
val BackgroundDeep = Color(0xFFE0E3E9) // Fondo secciones / accordions

// ── Sombras neumórficas ──────────────────────────────────────────────────────
val Shadow = Color(0xFFC2C8D4) // Sombra oscura (abajo-derecha)
val Light  = Color(0xFFFFFFFF) // Sombra clara (arriba-izquierda)
